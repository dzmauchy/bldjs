...
Cover UI-specific behavior (port clicks, wiring interaction, layout, pan/zoom, drag) with Selenium (`make test-e2e` / `npm run test:e2e`). Prefer Selenium tests over launching browser subagents.
