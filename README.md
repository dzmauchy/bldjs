...
- [AssemblyScript](https://www.assemblyscript.org/) compiles wired block functions to wasm (`c<T>` type aliases, no boxed consumers); each generator worker ticks with `setInterval` and writes a SharedArrayBuffer
- Vite
- TypeScript 7
