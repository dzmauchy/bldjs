import { type BlockDef, type ParamDef, type TypeExpr } from "@bld/model/blocks/ast";
import type { Catalog } from "@bld/model/blocks/catalog";
import { isCompatible } from "@bld/model/blocks/compat";
import { resolvedInput, resolvedOutput, type ResolvedBlock } from "@bld/model/blocks/resolve";
